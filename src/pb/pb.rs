...
pub mod sf {
    pub mod solana {
        ...
        pub mod raw {
            pub mod blocks {
                pub mod rewards {
                    // @@protoc_insertion_point(attribute:sf.solana.raw.blocks.rewards.v1)
                    pub mod v1 {
                        include!("sf.solana.raw.blocks.rewards.v1.rs");
                        // @@protoc_insertion_point(sf.solana.raw.blocks.rewards.v1)
                    }
                }
            }
        }
